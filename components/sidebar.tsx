...
<div className="relative flex items-center space-x-1">
  {!isCollapsed && !isClient && canCreateProjectsOrChannels && (
    <>
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10 overflow-hidden animate-fadeIn">
            <Link
              ...
              className="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-200 border-b border-gray-100"
