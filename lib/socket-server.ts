...
import {
  ...
  getMessageChannelId,
  getReactions,
  // getMessagePeers, // TODO: provide or remove if unused
  removeReactionJSON,
} from "./reactions";
import { db } from "./db";
      ...
      async (
        ...
        try {
          ...
          if (channelId) {
            ...
            // If it's a DM, broadcast to both ends (sender/receiver). You can implement getMessagePeers.
      ...
      async (
        ...
        try {
          ...
          if (channelId) {
            ...
            // DM peer broadcast (see comment above)
          }
          ack({ success: true, reactions: updated });
        } catch (e) {
