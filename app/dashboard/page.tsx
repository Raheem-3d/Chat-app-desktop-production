...
export default async function DashboardPage() {
  ...
  return (
    // <div className="min-h-screen bg-gray-50/50 dark:bg-gray-900 p-4 md:p-6">
    ...
    //           {/* Welcome Header */}
    //           <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 text-white shadow-lg border border-gray-200 dark:border-gray-700">
    ...
    //                   <p className="text-2xl font-bold text-white">{recentTasks.length}</p>
    //                 </div>
    ...
    //               </p>
    //             </div>
    //             <Button asChild className="bg-gray-900 hover:bg-gray-800 text-white shadow-sm transition-colors">
    ...
    //           {/* Projects Grid */}
    //           <Card className="rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-800 overflow-hidden">
    ...
    //                 <>
    //                   <Button asChild className="bg-gray-900 hover:bg-gray-800 text-white shadow-sm transition-colors">
    //                     <Link href="/dashboard/new-channel" className="flex items-center gap-2">
    //                       <PlusCircle className="h-4 w-4" />
    //                       New Channel
    //                     </Link>
    //                   </Button>
    //                   <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white shadow-sm transition-colors">
    ...
    //                     <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{recentChannels.length}</p>
    //                   </div>
    ...
    //                     <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{completedTasksCount}</p>
    //                   </div>
    ...
    //                     <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{inProgressTasksCount}</p>
    //                   </div>
    ...
    //                 <div className="flex items-center justify-between">
    //                   <div>
    //                     <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Recent Contacts</p>
    //                     <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{recentContacts.length}</p>
    //                   </div>
    ...
    //                   </CardDescription>
    //                 </div>
    //                 <Button variant="outline" size="sm" asChild className="rounded-lg border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
    ...
    //           {/* Analytics Charts - Compact Design */}
    ...
    //                 <div className="flex items-center justify-between">
    //                   <div>
    //                     <CardTitle className="text-gray-900 dark:text-white">Recent Channels</CardTitle>
    //                     <CardDescription className="text-gray-600 dark:text-gray-400">
    //                       Your recently active channels
    //                     </CardDescription>
    //                   </div>
    //                   <Button variant="outline" size="sm" asChild className="rounded-lg border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
    //                     <Link href="/dashboard/channels/all" className="flex items-center gap-1">
    //                       View All <ChevronRight className="h-4 w-4" />
    //                     </Link>
    //                   </Button>
    //                 </div>
    ...
    //                       className="flex items-center justify-between p-4 rounded-lg border border-gray-100 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 bg-gray-50/50 dark:bg-gray-700/50 hover:bg-white dark:hover:bg-gray-700 transition-all group"
    //                     >
    //                       <div className="flex items-center gap-4">
    //                         <div className="h-10 w-10 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30 transition-colors">
    ...
    //                     </div>
    //                     <p className="text-gray-500 dark:text-gray-400 font-medium">No channels yet</p>
    //                     <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
    ...
    //                 <div className="flex items-center justify-between">
    //                   <div>
    //                     <CardTitle className="text-gray-900 dark:text-white">Recent Contacts</CardTitle>
    //                     <CardDescription className="text-gray-600 dark:text-gray-400">
    //                       People you've recently messaged
    //                     </CardDescription>
    //                   </div>
    //                   <Button variant="outline" size="sm" asChild className="rounded-lg border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
    //                     <Link href="/dashboard/people" className="flex items-center gap-1">
    //                       View All <ChevronRight className="h-4 w-4" />
    //                     </Link>
    //                   </Button>
    //                 </div>
    ...
    //                     </div>
    //                     <p className="text-gray-500 dark:text-gray-400 font-medium">No recent contacts</p>
    //                     <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
    ...
    //   </div>
    // </div>
//     <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-900 dark:to-gray-800 p-4 md:p-6">
//   <div className="max-w-8xl mx-auto space-y-8">
//     {/* Subscription / Trial Banner */}
//     <SubscriptionBanner />
...
//               <Card 
//                 key={stat.title}
//                 className="rounded-2xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden"
//               >
...
//                       </p>
//                     </div>
//                     <div className={`h-14 w-14 rounded-2xl bg-${stat.color}-50 dark:bg-${stat.color}-900/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
