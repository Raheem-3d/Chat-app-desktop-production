...
import { CalendarIcon, Loader2, Plus, X, Users, Briefcase, Mail, Search } from "lucide-react"
...
export default function NewTaskPage() {
  ...
  const canAccess = useHasAccess(["ADMIN", "MANAGER"])
                    ...
                    <PopoverTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          !deadline && "text-gray-400 dark:text-gray-500"
                        )}
                      >
