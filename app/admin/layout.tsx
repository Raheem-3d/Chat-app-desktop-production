...
// // no headers import to avoid type issues in this setup
...
//       icon: '🏢',
//       children: [
//         { href: '/admin/organizations', label: 'All Organizations', icon: '📋' },
...
//       {/* Sidebar */}
//       <aside className="hidden lg:flex flex-col h-screen sticky top-0 border-r bg-white/95 dark:bg-gray-900/95 backdrop-blur">
//         <div className="p-4 border-b">
//           <Link href="/admin" className="flex items-center gap-2">
//             <span className="inline-block h-8 w-8 rounded-lg bg-gradient-to-br from-blue-600 to-cyan-500" />
//             <div>
